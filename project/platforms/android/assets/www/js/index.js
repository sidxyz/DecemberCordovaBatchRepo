...
var app = {
    ...
    onDeviceReady: function() {
        ...
        cordova.plugins.locationAccuracy.request(requestLocationSuccessCallback, requestLocationErrorCallback, accuracy)
...
function requestLocationSuccessCallback()
{
    console.log("request for high accuracy location succeeded!");
    navigator.geolocation.getCurrentPosition(onGeoLocationSuccessCallBack, onGeoLocationErrorCallBack);

}

function requestLocationErrorCallback()
{
    console.log("request for high accuracy location failed");
}


function onGeoLocationSuccessCallBack(position)
{
...
function onGeoLocationErrorCallBack()
{
